...
The following table is a list of the updates included in this package, their folder name within the package, [Link3](http://www.baidu.com)and the computer on which they should be installed [Link2](http://go.microsoft.com/fwlink/?LinkID=220766).

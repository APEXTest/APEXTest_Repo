...
In a previous tutorial,[testingggggggggggggggggggg] you learned how to SSH to a virtual machine (VM) and manually install NGINX. To create VMs in a quick and consistent manner, some form of automation is typically desired. A common approach to customize a VM on first boot is to use [cloud-init](https://cloudinit.readthedocs.io). In this tutorial you learn how to:
...
```azurecli-interactive 
group create --name myResourceGroupAutomate --location eastus
```
...
```azurecli-interactive 
az keyvault certificate create \ testinggggggggggggggggggggggggggggg
...
### Create cloud-init config to testingggggggggggggggg
...
## Test secure web ap testinggggggggg

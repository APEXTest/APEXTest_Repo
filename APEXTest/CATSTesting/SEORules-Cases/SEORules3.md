...
title: ''
description: This topic provides test cases in CATS to validate content with SEO rules - Title with Empty
...
# SEO Rules on Title metadata - Title with Empty

Page with "title" on metadata but the content is ''.
